...
* in the **Parameters** tab, add a new plugin repository name **Desimper** with the URL: https://github.com/3liz/qgis-liz-example-plugin/releases/latest/download/plugins.xml
